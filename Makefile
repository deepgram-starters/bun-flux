...
.PHONY: help check check-prereqs init install install-frontend build start start-backend start-frontend clean status update eject-frontend test

# Default target: show help
help:
	@echo "Bun Flux - Available Commands"
	@echo "========================================"
	@echo ""
	@echo "Setup:"
